...
public class VideoOkHttpHandler extends AsyncTask<String, Void, String> {
    VideoOkHttpHandler.OnVideoUpdateListener listener;

    public interface OnVideoUpdateListener {
        void onVideoUpdate(String s);
    }

    public void setVideoUpdateListener(OnVideoUpdateListener listener) {
    ...
    protected String doInBackground(String... s) {
        ...
        urlBuilder.addPathSegment(s[2]);// videos
